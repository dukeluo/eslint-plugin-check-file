...
ruleTester.run(
  "folder-naming-convention with option on Windows: [{ '*/__tests__/': 'PASCAL_CASE', 'src/*/': 'CAMEL_CASE' }]",
  rule,
  {
    valid: [
      {
        code: "var foo = 'bar';",
        filename:
          'src\\components\\DisplayLabel\\__tests__\\displayLabel.test.js',
...
ruleTester.run(
  "folder-naming-convention with option on Windows: [{ 'src/**/': 'CAMEL_CASE' }]",
  rule,
  {
    valid: [
      {
...
ruleTester.run(
  'folder-naming-convention with folder that has not been set on Windows',
  rule,
  {
    valid: [
      {
...
ruleTester.run(
  "folder-naming-convention with option on Windows: [{ '*/__tests__/': 'FOO', 'src/*/': 'CAMEL_CASE' }]",
  rule,
  {
    valid: [],
...
ruleTester.run(
  "filename-naming-convention with option on Windows: [{ '*/__tests__/': 'PASCAL_CASE', 'src/': 'CAMEL_CASE' }]",
  rule,
  {
    valid: [],
...
ruleTester.run(
  "filename-naming-convention with option on Windows: [{ '**/*.js': 'NEXT_JS_PAGE_ROUTER_FILENAME_CASE' }]",
  rule,
  {
    valid: [],
